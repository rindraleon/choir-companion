      ...
      <div className="px-5 -mt-2">
        <div className="grid grid-cols-3 gap-3">
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground">Hira</span>
          </button>
          <button
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground">Tiana</span>
          </button>
          <div className="flex flex-col items-center gap-1.5 p-4 rounded-xl bg-card border border-border/50">
            ...
            <span className="text-[10px] text-muted-foreground">Sokajy</span>
          </div>
        </div>
      </div>
